...
urlpatterns = [
    ...
    path('videos/<int:pk>/generate/', views.GenerateVideoView.as_view(), name='video-generate'),
    ...
    path('audio/<int:pk>/generate/', views.AudioGenerateVideoView.as_view(), name='audio-generate-video'),
